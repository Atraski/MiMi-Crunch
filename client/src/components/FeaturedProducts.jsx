          ...
          {featured.map((item) =>
            item.slug ? (
              <Link
                ...
                className="flex flex-col gap-3 rounded-3xl border border-stone-200/70 bg-white/95 p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-md cursor-pointer"
              ...
              >
                ...
                <span className="btn btn-ghost mt-1 w-fit px-4 py-1.5 text-sm">
                  View Product
                </span>
              </Link>
            ) : (
              ...
              >
                ...
                <button className="btn btn-ghost mt-1 w-fit px-4 py-1.5 text-sm" type="button" disabled>
                  View Product
                </button>
              </article>
            ),
