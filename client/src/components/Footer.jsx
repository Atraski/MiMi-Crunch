      ...
      <footer className="relative z-10 mx-auto max-w-7xl px-3 pt-20 pb-12 lg:px-4">
          ...
          <div>
            ...
            <ul className="mt-6 space-y-4 text-sm">
              <li className="flex items-center gap-3 text-emerald-200/70">
                ...
                <a href="mailto:support@mimicrunch.com" className="hover:text-emerald-400 transition-colors">
        ...
        <div className="mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6">
            <a href="https://www.instagram.com/mimicrunch.in" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-emerald-400 hover:bg-emerald-400 hover:text-emerald-950 transition-all duration-300">
