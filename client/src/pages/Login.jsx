          ...
          {step === 'email' ? (
            <>
              <div className="text-center mb-8">
                <h1 className="text-4xl font-[Fraunces] text-[#1B3B26] font-medium mb-3 tracking-tight">Log in / Sign up</h1>
              ...
              <form className="space-y-5" onSubmit={handleSendOtp}>
                <div className="space-y-1.5">
                  <label className="block text-sm font-semibold text-[#1B3B26] pl-1" htmlFor="login-email">
                    Email Address
                  </label>
                  <input
                    id="login-email"
            ...
            <>
              ...
              <form className="space-y-6" onSubmit={handleVerifyOtp}>
                <div>
                  <label className="block text-sm font-semibold text-[#1B3B26] pl-1 text-center mb-2" htmlFor="login-otp">
                    Verification code
                  </label>
                  <input
                    id="login-otp"
              ...
              <p className="mt-8 text-center text-sm text-[#4A5D4E]">
                ...
                <Link to="/signup" className="font-bold text-[#F5B041] hover:text-[#d99732] hover:underline transition-colors">
                  Sign up instead
                </Link>
              </p>
            </>
